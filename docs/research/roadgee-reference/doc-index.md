...
RoadGee是一款同时支持道路 **交叉口**、 **横断面** 和 **干道绿波** 的设计分析软件。基于HTML5技术研发，使用浏览器 [登录](https://www.roadgee.com/passport/login/index.html) 后即可使用，支持多人同时在线，项目数据云存储更加安全可靠。

## 1.交叉口设计分析软件

（1）通过参数化的形式，快速设计出交叉口 [渠化图](https://www.roadgee.com/static/dist/index/imgs/step2.png?t=250125)、 [流量图](https://www.roadgee.com/static/dist/index/imgs/step3.png?t=250125)， **图形美观**，所有用户均支持 [地图模式](https://www.roadgee.com/static/dist/index/imgs/step_map.png?t=250125)。

（2）输入信号 [控制方案](https://www.roadgee.com/static/dist/index/imgs/step4.png?t=250125)，自动计算交叉口的 [饱和度](https://www.roadgee.com/static/dist/index/imgs/step5.png?t=250125)、 [延误时间](https://www.roadgee.com/static/dist/index/imgs/step6.png?t=250125)、 [排队长度](https://www.roadgee.com/static/dist/index/imgs/step7.png?t=250125) 和 [服务水平](https://www.roadgee.com/static/dist/index/imgs/step8.png?t=250125) 等评价指标。

（3）支持 **自动配时** 功能，根据设计目标饱和度，自动计算Y值、信号周期及各相位最优绿灯时间。

（4）计算精确， [方法公开](https://www.roadgee.com/doc/vc)，支持 [早启迟断式（搭接相位）等多种信号控制](https://www.roadgee.com/doc/example2) 计算。

![RoadGee交叉口设计分析软件](https://www.roadgee.com/static/dist/index/imgs/step2.png?t=250125)

## 2.道路横断面设计软件

快速生成道路横断面图，元素类型丰富，支持 **实景** 和 **简绘** 两种风格。

![RoadGee道路横断面设计软件](https://www.roadgee.com/static/dist/index/imgs/hdm1.png?t=250125)

## 3.干道绿波设计软件

快速生成绿波效果图， **一键优化** 功能可轻松实现数解法计算，自动计算半周期长度、相位差、带宽、带速等。

同时支持 **图解法**、 **[经典数解法](https://www.roadgee.com/doc/band#m0)**、 **[优化数解法](https://www.roadgee.com/doc/band#m1)**、 **[MaxBand法](https://www.roadgee.com/doc/band_method)**、 **[逐渐拟合法](https://www.roadgee.com/doc/band_method)** 等优化方案。

![RoadGee干道绿波设计软件](https://www.roadgee.com/static/dist/doc/imgs/band2.png?t=250125)

* * *

下一篇： [道路横断面设计软件](https://www.roadgee.com/doc/index?a=m1#m1)
